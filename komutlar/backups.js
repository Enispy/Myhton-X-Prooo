...
[Destek](https://discord.gg/mNd4kSt)`
          )
          .setColor("BLACK");
...
[Destek](https://discord.gg/mNd4kSt)`);
        ...
        let cantfindbackup = new RichEmbed()
          ...
          .setDescription("[Destek](https://discord.gg/mNd4kSt)")
          .setColor("BLACK");
        if (!backups[message.author.id][code])
          return message.channel.send(cantfindbackup);
...
`
          ...
          .setDescription(
            `
                m!yedek al : Sunucunuzu yedek alırsınız.
                m!yedek sil : Sunucu yedeğinizi silersiniz.
                m!yedek bilgi : Sunucu yedeğiniz hakkında bilgi alırsınız.
                m!yedek yükle : Sunucu yedeğinizi yüklersiniz.
                m!yedek temizle : Tüm yedeklerinizi silersiniz.
                [Destek](https://discord.gg/mNd4kSt)
